...
const PLDashboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const lecturersData = Array.isArray(lecturersRes.data) ? lecturersRes.data : lecturersRes.data.lecturers || [];
                ...
                <Form onSubmit={handleAddModule}>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <Form.Text className="text-muted">
                      Assigning a lecturer here will make this module appear in their dashboard
                    </Form.Text>
                  </Form.Group>
                  <Form.Group className="mb-3">
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <ul className="list-unstyled">
                  ...
                  <li>✅ Active Lecturers: {lecturers.length}</li>
